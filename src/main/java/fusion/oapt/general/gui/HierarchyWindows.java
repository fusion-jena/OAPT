...
import fusion.oapt.general.visualization.HierarchyCalculation;
...
public class HierarchyWindows {
    ...
    public static void showHierarchy(int numModule) {
	    ...
	    ModuleName = "./temp/" + ontName + "_Module_"+ numModule  + ".owl"; // Read our created modules
//	    ModuleName = ontName + numModule  + ".owl"; // Read our created modules
      ...
      //  BuildModel.BuildModelOnt(ModuleName);
        ...
        MB.build();
    	HierarchyCalculation.ShowTreeCalculating(MB.getModel());//(BuildModel.OntModel);
    	int a = numModule +1;
