...
//import fusion.oapt.general.comparing.ComparingTest;
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
    private void AnalysisButtonActionPerformed(ActionEvent evt) {
    	...
    	ModelBuild MB;
    	OntModel model=null;
    	MB=new ModelBuild(AnalysisPanel.NameAddressOnt1);
        ...
        if (NameAddressOnt1.length() > 0  ) {
            ...
            Analysis AT=new Analysis(model,MB.getOWLModel(), MB.getRBGModel());
            AT.AnalyzingTestRun();
            analysisTest = true;
