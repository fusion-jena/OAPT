...
public class MergeTest {
	...
	public static void main(String[] args) throws Exception {
		String path="resources/ont";
		MergeTest MA=new MergeTest(path);
		MA.readFiles(path);
       MA.run();
	}
	...
	public static  String convert(String name) throws Exception
	{
       ...
       //  if(model!=null)
        ...
        /********* Load the meta-model **********/
        String fmtatOnto= "src/resources/merge/metamodelOwl.ggx";  
	...
	private OWLOntology execute_parallel() throws Exception
	{
		...
		// List<Future> futurelist2=new ArrayList<Future>();
		 ...
		 {
			 String Sgraph=graphNames.get(i);
			 String Tgraph=graphNames.get(i+1);
