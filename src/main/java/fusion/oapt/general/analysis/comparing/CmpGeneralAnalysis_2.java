...
public class CmpGeneralAnalysis_2
{
    ...
    OntModel model;
	  ...
	  public CmpGeneralAnalysis_2(OntModel ont)
	  {
		  Number_of_classes=0;
		  Number_of_tot_classes=0;
		  Number_of_Property=0;
 ...
 public void GeneralTest(){
	 ...
	 List list=new ArrayList();
	 AnalysisPanel.GeneralTextArea2.append("==============  Statistical metrics ==========  \n" );
	 	 
	 AnalysisPanel.GeneralTextArea2.append("\n" + "---> Number of Named Classes:\t " + Number_of_classes +"\n") ; 
